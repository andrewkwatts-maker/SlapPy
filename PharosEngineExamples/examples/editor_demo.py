...
Requirements: pip install Pharos Engine[editor]
...
try:
    ...
    print("Install with:  pip install Pharos Engine[editor]")
    raise SystemExit(1)
...
engine = se.Engine(title="Pharos Engine — Editor Demo")
...
print("Opening Pharos Engine editor...")
