...
Run::
    ...
    PYTHONPATH=python python PharosEngineExamples/examples/hello_hybrid_layers.py
    PYTHONPATH=python python PharosEngineExamples/examples/hello_hybrid_layers.py --frames 30
"""
...
def _parse_args(argv: List[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Hello Hybrid Layers -- Pharos Engine DDD3 demo")
