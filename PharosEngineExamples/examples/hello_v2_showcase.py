...
Run:
    python PharosEngineExamples/examples/hello_v2_showcase.py
"""
...
def _step_command_palette(trace: DemoTrace) -> int:
    ...
    try:
        from pharos_editor.ui.editor.notebook_command_palette import (
...
def _step_layout_baker(trace: DemoTrace, tmp_root: Path) -> str:
    ...
    try:
        from pharos_editor.ui.editor.layout_baker import LayoutBaker
    except Exception as exc:
...
def _step_timeline_editor(trace: DemoTrace) -> int:
    ...
    try:
        from pharos_editor.ui.editor.notebook_timeline_editor import Timeline
    except Exception as exc:
