...
Nova3D parity Sprint 6: JJ5's :class:`~pharos_engine.render.scene_walker.SceneWalker`
...
try:  # pragma: no cover - trivial guard
    from pharos_engine.render.scene_walker import Frustum as _JJ5Frustum  # noqa: F401
...
class BVH3D:
    ...
    def query_frustum(self, frustum: Any) -> list[str]:
        ...
        Accepts JJ5's :class:`~pharos_engine.render.scene_walker.Frustum`
