...
:class:`~pharos_engine.render.null_renderer.NullRenderer` skips shader
...
# ----------------------------------------------------------------------
UNLIT_3D_WGSL = """// pharos_engine unlit_3d
...
# ----------------------------------------------------------------------
PHONG_3D_WGSL = """// pharos_engine phong_3d
...
# ----------------------------------------------------------------------
SPRITE_2D_WGSL = """// pharos_engine sprite_2d
struct Camera { view_proj: mat4x4<f32> };
...
# ----------------------------------------------------------------------
LINE_3D_WGSL = """// pharos_engine line_3d
struct Camera { view_proj: mat4x4<f32> };
@group(0) @binding(0) var<uniform> cam: Camera;
...
# ----------------------------------------------------------------------
DEPTH_ONLY_WGSL = """// pharos_engine depth_only
struct Camera { view_proj: mat4x4<f32> };
struct Model  { model: mat4x4<f32>, color: vec4<f32> };
