...
class PostProcessChain:
    ...
    def add_tonemap(
        ...
        :class:`~pharos_engine.post_process.auto_exposure.AutoExposurePass`
    ...
    def add_bloom(
        ...
        Delegates to :class:`~pharos_engine.post_process.bloom.BloomPass` so the
    ...
    def add_dof(
        ...
        Convenience wrapper over :class:`~pharos_engine.post_process.dof.DofPass`.
