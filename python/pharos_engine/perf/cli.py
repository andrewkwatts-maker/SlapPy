...
Usage::
    ...
    python -m pharos_engine.perf.tripwire            # bench + compare + table
    python -m pharos_engine.perf.tripwire --write-baseline
    python -m pharos_engine.perf.tripwire --steps 30 --trials 2 --tolerance 20
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p = argparse.ArgumentParser(
        prog="python -m pharos_engine.perf.tripwire",
