...
class ScriptBinding:
    ...
    def subscribe_events(self, entity: Any) -> list[int]:
        ...
        """
        from pharos_engine.event_bus import subscribe as _subscribe
    ...
    def _find_handler(self, entry: "SubscriptionEntry", entity: Any) -> Callable | None:
        ...
        from pharos_engine.event_bus import EventDetails as _ED
    ...
    def unsubscribe_events(self, handles: list[int]) -> None:
        ...
        from pharos_engine.event_bus import unsubscribe as _unsub
        for h in handles:
            _unsub(h)
        handles.clear()
