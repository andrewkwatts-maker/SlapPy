"""pharos_engine.deform_modes — Enumerations and config objects for DeformableLayerComponent.
...
class CellMaterial:
    ...
    # through :func:`pharos_engine.physics.pressure_multigrid.vcycle_project_v`,
    ...
    # path (see ``pharos_engine.physics.render``).
