...
from pharos_engine.compute.stats import StatsCompute, StatsResult
from pharos_engine.compute.spatial import SpatialCompute, AABB
from pharos_engine.compute.mutator import PixelMutator
...
class PixelAPI:
    ...
    def apply(self, *, filter, mutation, target_channel: str,
              layer: int = 0) -> None:
        from pharos_engine.compute.ast_compiler import compile_apply_shader, ASTCompilerError
