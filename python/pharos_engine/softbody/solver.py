...
# `_HAS_NATIVE_RASTER` switch in :mod:`pharos_engine.softbody.render`.
...
try:
    ...
    _HAS_NATIVE_FULL_STEP = (
        _HAS_NATIVE_SOLVER and hasattr(_native_core, "pharos_engine_step")
    )
...
def _run_native_full_step(world: SoftBodyWorld,
    ...
    ``_core.pharos_engine_step`` and copies the mutated buffers back into
    ...
    _native_core.pharos_engine_step(
