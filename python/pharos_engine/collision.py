...
# `pharos_engine.collision` even though the class actually lives in
# `pharos_engine.collision_pixel`. Re-export it here so the legacy import
# path resolves. Guard the import so a broken collision_pixel module
# never breaks `import pharos_engine.collision`.
# DO NOT REMOVE without a v1.0 deprecation cycle.
try:
    from pharos_engine.collision_pixel import PixelCollisionPass  # noqa: F401
