"""Default-config YAML generator + validator for Pharos Engine.
...
Pharos Engine typically wants to expose to the end-user.
...
DEFAULT_CONFIG_OPTIONS: list[ConfigOption] = [
    # -------------------- window --------------------
    _opt("window.title", "Pharos Engine", "str",
...
def generate_default_yaml(
    *,
    ...
    lines: list[str] = [
        "# Pharos Engine default configuration",
        "# ----------------------------------",
