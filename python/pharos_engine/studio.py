...
For a fluid + softbody scene::
    ...
    from pharos_engine.studio import fluid_with_softbody_stage, record
...
class Stage:
    ...
    Attributes:
        ...
        dynamics: optional :class:`pharos_engine.dynamics.World` instance
...
def dynamics_stage(world: "DynamicsWorldLike | None" = None, *,
    ...
    """Build a stage around a :class:`pharos_engine.dynamics.World`.
