...
:class:`~pharos_engine.tool_router.ToolAction` rows added by the JJ6
STUB-triage sprint tick (round 12 after
X3 / Y1 / Z7 / AA1 / BB1 / CC1 / DD1 / EE1 / FF1 / GG1 / II5).

Sibling helpers to
:mod:`pharos_engine.actions.edit_hide_show_actions` — lock/unlock is the
...
:mod:`pharos_engine.actions.edit_invert_selection_actions._is_locked`
...
def lock_selection(ctx: dict[str, Any]) -> dict[str, Any]:
    ...
    :func:`pharos_engine.actions.edit_invert_selection_actions.invert_selection`
