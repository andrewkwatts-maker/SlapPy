...
Backs the ``view.frame_selected`` :class:`~pharos_engine.tool_router.ToolAction`
...
Distinct from the already-wired :func:`pharos_engine.actions.viewport_framing_actions.center_on_selection`
