...
Backs the ``view.reset_view`` :class:`~pharos_engine.tool_router.ToolAction`
...
Distinct from :func:`pharos_engine.actions.camera_actions.zoom_reset`
(which only touches the zoom knob) and
:func:`pharos_engine.actions.viewport_framing_actions.frame_all` (which
