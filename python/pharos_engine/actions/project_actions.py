...
and ``editor.open_recent`` :class:`~pharos_engine.tool_router.ToolAction`
rows in :data:`pharos_engine.tool_router.REGISTRY`. They exist as free
...
def _get_project_from_ctx(ctx: dict[str, Any]) -> Any:
    """Extract a live :class:`~pharos_engine.projects.Project` handle.
