...
from pharos_engine.scene_node import SceneNode
...
class Scene:
    def __init__(self, name: str = "Scene"):
        from pharos_engine.collision import CollisionManager
        self.name = name
    ...
    def add_layer(self, layer) -> None:
        """Add a :class:`~pharos_engine.layer.Layer` (Layer2D or Layer3D).
