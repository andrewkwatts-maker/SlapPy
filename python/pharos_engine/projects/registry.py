...
def _default_store_path() -> Path:
    """Return the default registry YAML path (``~/.pharos_engine/projects.yaml``)."""
...
class ProjectRegistry:
    ...
    The registry lives at ``~/.pharos_engine/projects.yaml`` by default;
...
def get_default_registry() -> ProjectRegistry:
    ...
    :mod:`pharos_engine.projects` does not touch the user's home
