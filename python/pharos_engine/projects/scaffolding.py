...
When a new :class:`~pharos_engine.projects.project.Project` is created
...
The engine's :class:`pharos_engine.assets.AssetDatabase` scans this
...
from pharos_engine import Engine, Scene
