    ...
    def attach_script(self, script) -> None:
        ...
        if not isinstance(script, Script) and not hasattr(script, 'on_update'):
            ...
            warnings.warn(
                ...
                "Consider subclassing pharos_engine.Script for IDE support and type hints.",
                stacklevel=2,
            )
