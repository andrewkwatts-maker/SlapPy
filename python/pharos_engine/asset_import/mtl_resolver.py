...
* :func:`mtl_to_material` — convert an :class:`MtlMaterialDef` into an
  HH4 :class:`pharos_engine.render.material.Material`, using a
...
The Material import is *soft* — if :mod:`pharos_engine.render.material`
...
def _soft_material_types() -> tuple[Any, Any]:
    ...
    try:
        from pharos_engine.render.material import (  # noqa: PLC0415
            Material,
            TextureHandle,
        )
