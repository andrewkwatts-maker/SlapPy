...
from pharos_engine._asset_validation import (
    validate_blend,
...
if TYPE_CHECKING:
    from pharos_engine.material import MaterialMap
...
class Asset(RenderTarget):
    def __init__(self, name: str = "", position=(0.0, 0.0), size=(64, 64)):
        ...
        # ``engine_config`` which imports ``pharos_engine`` which imports
        # ``asset``). See docs/game_compat_2026_07_07.md § 11.4.
        # DO NOT REMOVE without a v1.0 deprecation cycle.
        from pharos_engine.residency.manager import CacheMode as _CacheMode
