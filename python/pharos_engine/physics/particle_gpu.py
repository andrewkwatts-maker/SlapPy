...
def _numpy_collide(field: "ParticleField", dt: float) -> None:
    ...
    if field.pos.shape[0] == 0:
        return
    from pharos_engine.physics.particle_field import Phase
...
# ``pharos_engine.physics.baked_terrain.bake_settled_particles``. Per
...
def _numpy_bake_settled(field: "ParticleField") -> None:
    ...
    from pharos_engine.physics.baked_terrain import bake_settled_particles
