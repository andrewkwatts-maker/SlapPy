...
(:mod:`pharos_engine.ui.theme.shader_lint`) with a filesystem watcher
that re-runs :func:`~pharos_engine.ui.theme.shader_lint.lint_wgsl`
...
pattern used by :mod:`pharos_engine.ui.user_overrides`:
