...
the class applies :func:`~pharos_engine.ui.theme.edge_strokes.render_edge_stroke`
...
lives in :mod:`pharos_engine.ui.theme.dpg_bridge`.
"""
...
class PanelDecorator:
    ...
    ----------
    edge_stroke_preset:
        A key from :data:`~pharos_engine.ui.theme.edge_strokes.EDGE_STROKE_PRESETS`.
    ...
    def build_edge_tiles(
        ...
        :func:`~pharos_engine.ui.theme.edge_strokes.render_stroke_border`.
        """
