...
The editor-side :mod:`pharos_engine.ui.theme` package ships full palettes,
...
def _try_lookup_theme(theme_id: str) -> Any | None:
    ...
    try:
        from pharos_engine.ui import theme as _theme_pkg  # type: ignore[import-not-found]
    ...
    if theme_id not in registered:
        ...
        # pharos_engine.ui.theme.themes and self-registers on import.
        try:
            from pharos_engine.ui.theme import themes as _themes_pkg  # type: ignore
