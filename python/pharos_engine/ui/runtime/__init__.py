...
The :mod:`pharos_engine.ui.runtime` package provides a *lightweight*,
DPG-free UI stack usable from a game tick loop. The editor-side
:mod:`pharos_engine.ui.editor` package is a superset (dockable panels,
...
* Theme colours come from :class:`RuntimeTheme`, which soft-imports the
  editor :class:`~pharos_engine.ui.theme.theme_spec.ThemeSpec` when
