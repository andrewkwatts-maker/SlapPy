...
:class:`~pharos_engine.post_process.chain_manifest.ChainManifest`
...
Header row
    * Preset **dropdown** — populated from a bound
      :class:`~pharos_engine.post_process.chain_baker.ChainBaker`.  When
...
class NotebookPPPreviewPanel:
    ...
    ----------
    baker:
        Optional :class:`~pharos_engine.post_process.chain_baker.ChainBaker`.
