...
:func:`pharos_engine.ui.theme.get_active_theme` and writes via
:func:`pharos_engine.ui.theme.apply_theme`. Creature toggles route
...
Integration
-----------
Register with :class:`pharos_engine.ui.editor.shell.EditorShell` from
...
def _color_tuple(color: Any, default: tuple[int, int, int, int]) -> tuple[int, int, int, int]:
    ...
    Accepts :class:`pharos_engine.ui.theme.Color`, plain 4-tuples / lists,
...
class ThemeSwitcherPanel:
    ...
    :class:`~pharos_engine.ui.editor.shell.EditorShell.register_panel` and
    ...
    scheduler:
        ...
        :class:`pharos_engine.ui.theme.creatures.CreatureScheduler`
    ...
    def card_preview(self, theme_id: str) -> dict[str, Any]:
        ...
        try:
            from pharos_engine.ui.theme import _REGISTRY
