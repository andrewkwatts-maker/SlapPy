...
:class:`pharos_engine.ui.editor.material_editor.MaterialEditor` that
...
``material_map``
    A :class:`pharos_engine.material.map.MaterialMap` — the top row
...
``softbody``
    A :class:`pharos_engine.softbody.material.Material` dataclass — the
    swatch row shows ``render_color`` and ``damage_color``.

``fluid``
    A :class:`pharos_engine.fluid.material.FluidMaterial` dataclass —
