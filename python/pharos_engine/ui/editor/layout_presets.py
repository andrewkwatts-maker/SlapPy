...
:class:`pharos_engine.ui.editor.layout_persistence.PanelLayoutState`
...
:mod:`pharos_engine.ui.editor.shell` (rows 1-3 of the ``editor_root``
window).
"""
...
from pharos_engine._validation import validate_non_empty_str, validate_str
from pharos_engine.ui.editor.layout_persistence import PanelLayoutState
