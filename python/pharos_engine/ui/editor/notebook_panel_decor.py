...
* Rotated 4-8 degrees off-axis for the hand-placed feel — DPG has no
  ...
  :func:`pharos_engine.ui.theme.washi_tape.rotate_washi_tape` before it
  becomes a texture.
* Picked from one of four presets registered in
  :data:`pharos_engine.ui.theme.washi_tape.WASHI_TAPE_PRESETS`
...
:class:`pharos_engine.ui.editor.panel_decor.PanelDecor` (which handles
divider strokes + corner stickers on floating windows) or the
:class:`pharos_engine.ui.editor.panel_extras.ExtendedPanelDecorator`
