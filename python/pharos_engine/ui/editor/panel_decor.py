...
:class:`pharos_engine.ui.theme.PanelDecorConfig`, so switching theme
...
class WashiCornerSpec:
    ...
    tape_style_id:
        ...
        :class:`pharos_engine.ui.theme.washi_tape.WashiTapeStyle` id
    ...
    def __post_init__(self) -> None:
        ...
        if self.tape_style_id is not None:
            ...
            from pharos_engine.ui.theme.washi_tape import WASHI_TAPES
