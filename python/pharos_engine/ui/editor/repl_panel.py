...
``pharos_engine.ui.editor``. The shell instantiates the panel, hands it a
...
from pharos_engine.editor import helpers as _helpers
...
def make_repl_panel(app: Any = None, scene: Any = None) -> REPLPanel:
    ...
    Used by :class:`pharos_engine.ui.editor.shell.EditorShell` so the
