"""pharos_engine.ui.editor.deform_panel — REMOVED.
...
"""
raise ImportError(
    "pharos_engine.ui.editor.deform_panel was decommissioned in Phase D "
    "step 6 (2026-06-01). Both DeformPanel and ZoneEditorPanel are retired "
    "surface — their replacement is the property inspector at "
    "pharos_engine.ui.editor.property_inspector wired against softbody.Body "
