...
An extension sibling of :class:`pharos_engine.ui.editor.notebook_spawn_menu.NotebookSpawnMenu`.
...
* Style reference: :mod:`pharos_engine.ui.editor.notebook_spawn_menu`
...
class NotebookPrefabMenu:
    ...
    def _dpg_context_alive(dpg: Any) -> bool:
        ...
        :data:`pharos_engine.ui.editor.notebook_prefab_menu.
