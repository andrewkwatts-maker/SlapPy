...
class EditorShell:
    ...
    def __init__(
        ...
        # is missing.
        try:
            from pharos_engine.ui.editor.snap_manager import SnapManager
        ...
        from pharos_engine.ui.editor.layout_persistence import LayoutPersistence
        ...
        try:
            from pharos_engine.ui.editor.diary_shell import DiaryShell
    ...
    def _dispatch_editor_command(self, command: str) -> None:
        ...
        :data:`pharos_engine.tool_router.REGISTRY`. This dispatcher
        ...
        """
        from pharos_engine.tool_router import REGISTRY as _ROUTER
    ...
    def toggle_panel(self, panel_id: str) -> bool:
        ...
        """
        from pharos_engine.ui.editor.layout_presets import PanelLayoutState
    ...
    def register_panel(self, panel) -> None:
        ...
        * The panel is routed to a *named slot* on the shell when its
        ...
        # — keeping :mod:`pharos_engine.ui.editor.shell` import-cheap.
    ...
    def setup_theme_subsystem(self) -> None:
        ...
        from pharos_engine.ui.theme.creatures import CreatureBusAdapter
        ...
        try:
            from pharos_engine.ui.theme import get_baked_background
    ...
    def load_user_overrides(self) -> None:
        ...
        * WGSL shaders are handed to the matching theme registry.
        ...
        if bundle.spawn_actions:
            try:
                from pharos_engine.ui.editor import spawn_menu as _sm
        ...
        for shader_id, wgsl in bundle.shaders.items():
            ...
            try:
                if kind == "page_linings":
                    ...
                    from pharos_engine.ui.theme.washi_tape.library import (
                    ...
                    from pharos_engine.ui.theme.edge_strokes.library import (
    ...
    def setup_notebook_panels(self) -> None:
        ...
        if self._viewport_3d_panel is None:
            try:
                from pharos_engine.ui.editor.viewport_3d_panel import (
                    Viewport3DPanel,
                )
    ...
    def setup(self) -> None:  # noqa: C901 (complexity — UI layout)
        ...
        # outliner is built.
        from pharos_engine.ui.editor import spawn_menu as _spawn_menu
        ...
        if getattr(self, "_wgsl_panel", None) is None:
            try:
                from pharos_engine.ui.editor.wgsl_editor_panel import (
                    WGSLEditorPanel,
                )
        ...
        if self._code_mode_panel is None:
            try:
                from pharos_engine.ui.editor.code_mode_panel import (
                    CodeModePanel,
                )
    ...
    def run(self) -> None:
        ...
        try:
            from pharos_engine.ui.theme.dpg_bridge import mark_dpg_context_ready
    ...
    def _populate_layout_presets_menu(self) -> None:
        ...
        try:
            ...
            return
        from pharos_engine.ui.editor.layout_presets import PRESETS
