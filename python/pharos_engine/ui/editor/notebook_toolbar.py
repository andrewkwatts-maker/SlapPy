...
:class:`pharos_engine.ui.editor.toolbar.EditorToolbar`. Tool buttons are
...
:meth:`pharos_engine.ui.theme.nine_slice.NineSlice.render_procedural`.
...
from pharos_engine.ui.theme.nine_slice import NineSlice
...
class NotebookToolbar:
    ...
    * An optional 32×32 creature slot is reserved at the right margin; the
    ...
    def _lookup_themespec():
        ...
        Importing ``pharos_engine.ui.theme`` at module load would pull the
