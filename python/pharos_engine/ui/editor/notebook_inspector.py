...
:class:`pharos_engine.ui.editor.property_inspector.PropertyInspector`. It
...
but wraps each section in a :class:`~pharos_engine.ui.widgets.WashiPanel`
"field journal" page, swaps drag-floats for
:class:`~pharos_engine.ui.widgets.HighlighterSlider` strips, swaps bool
checkboxes for :class:`~pharos_engine.ui.widgets.HeartCheckbox` hearts,
and inserts a :class:`~pharos_engine.ui.widgets.DoodleSeparator` between
sections.
...
from pharos_engine.ui.editor.notebook_inspector_dispatch import (
...
class NotebookInspector(InspectorDispatchMixin):
    ...
    :mod:`pharos_engine.ui.editor.property_inspector` so dataclass fields
    work for free.
