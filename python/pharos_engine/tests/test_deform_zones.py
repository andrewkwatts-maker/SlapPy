"""Tests for pharos_engine.deform_zones — ZoneMap pixel zone tagging system."""
...
from pharos_engine.deform_zones import ZoneMap, ZoneDef
...
class TestZoneIntegrityFromAlpha(unittest.TestCase):
    def test_zero_alpha_region_reports_zero_integrity(self):
        ...
        with patch("pharos_engine.deform_zones.publish"):
            zm.update(img)
...
class TestZoneDestroyEvents(unittest.TestCase):
    def test_destroy_event_fired_at_threshold(self):
        ...
        with patch("pharos_engine.deform_zones.publish") as mock_pub:
