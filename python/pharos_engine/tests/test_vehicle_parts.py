"""Tests for pharos_engine.vehicle_parts — VehiclePartSystem."""
...
# Ensure the pharos_engine package is importable when running directly from the
# tests directory (pytest discovers the package via conftest / sys.path anyway).
_pkg_root = os.path.join(os.path.dirname(__file__), "..", "..", "..")
if _pkg_root not in sys.path:
    sys.path.insert(0, _pkg_root)

from pharos_engine.vehicle_parts import (
    VehiclePartSystem,
    PartStats,
    PartSlot,
    PART_PRESETS,
