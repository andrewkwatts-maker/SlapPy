"""Internal input-validation helpers for :mod:`pharos_engine.material.node_material`.

Generic validators (``validate_finite_float``, ``validate_unit_float``,
``validate_non_empty_str``, ``validate_str``, ``validate_finite_2tuple``)
live in :mod:`pharos_engine._validation` and are re-exported. Domain helpers
