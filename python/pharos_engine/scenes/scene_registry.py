...
The registry mirrors :class:`pharos_engine.prefabs.PrefabLibrary`'s
...
from pharos_engine._validation import validate_path_like
...
class SceneRegistry:
    ...
    def load(self, path: Path | str) -> Scene:
        ...
        name — matches :class:`~pharos_engine.prefabs.PrefabLibrary`'s
        semantics.
