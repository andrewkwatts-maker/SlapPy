...
This is a thin wrapper that lets `pharos_engine.audio` import cleanly whether
...
`pharos_engine.audio` (AudioManager / SoundHandle). The `get_backend()`
...
_LOG = logging.getLogger("pharos_engine.audio")
