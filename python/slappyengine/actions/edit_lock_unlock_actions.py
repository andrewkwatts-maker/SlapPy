...
Sibling helpers to
:mod:`slappyengine.actions.edit_hide_show_actions` — lock/unlock is the
...
:mod:`slappyengine.actions.edit_invert_selection_actions._is_locked`
...
def lock_selection(ctx: dict[str, Any]) -> dict[str, Any]:
    ...
    :func:`slappyengine.actions.edit_invert_selection_actions.invert_selection`
