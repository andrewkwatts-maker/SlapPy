...
Backs the ``content.copy_asset_path`` :class:`~slappyengine.tool_router.ToolAction`
row added by the CC1 STUB-triage sprint tick.

The action prefers routing through
:meth:`slappyengine.ui.editor.notebook_content_browser.NotebookContentBrowser.copy_path`
