...
Backs the ``view.reset_view`` :class:`~slappyengine.tool_router.ToolAction`
...
Distinct from :func:`slappyengine.actions.camera_actions.zoom_reset`
(which only touches the zoom knob) and
:func:`slappyengine.actions.viewport_framing_actions.frame_all` (which
