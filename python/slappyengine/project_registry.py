...
:mod:`slappyengine.projects.registry`. Where the latter is tightly
...
The registry file lives at ``~/.slappyengine/projects.yaml`` and is
...
:mod:`slappyengine.projects` so both layers can evolve independently
...
def _engine_version_default() -> str:
    """Return ``slappyengine.__version__`` with graceful fallback."""
    try:
...
class RegisteredProject:
    ...
    engine_version:
        ...
        the current ``slappyengine.__version__`` so callers rarely
...
# ---------------------------------------------------------------------------
# Singleton accessor — mirrors ``slappyengine.projects.get_default_registry``.
# ---------------------------------------------------------------------------
