...
Lets a :class:`~slappyengine.layer.Layer2D` sample a
:class:`~slappyengine.layer.Layer3D`'s render target (and vice versa) so
...
* :func:`apply_post_process_from` — post-process pattern used by
  :meth:`~slappyengine.layer.Layer2D.apply_post_process_from`.
* :func:`use_layer_as_texture` — 3D-material pattern used by
  :meth:`~slappyengine.layer.Layer3D.use_layer_as_texture`.
"""
