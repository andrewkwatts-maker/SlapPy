...
This module is imported by :mod:`slappyengine.physics.__init__` and, as a
side effect of that import, wraps
:func:`slappyengine.physics.world.load_physics_config` so the returned
...
storage (each :class:`~slappyengine.physics.cell.CellGridPool` slot is 64 KB,
...
# See ``slappyengine.physics.cell.CellGridPool`` for the canonical layout.
...
def _install_memory_section_on_physics_yaml() -> None:
    ...
    :mod:`slappyengine.physics.__init__`.
    """
    # Local import to avoid a circular import at module load.
    from slappyengine.physics import world as _world_mod
