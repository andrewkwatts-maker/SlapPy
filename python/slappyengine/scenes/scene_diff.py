"""``slappyengine.scenes.scene_diff`` — structured Scene-to-Scene diff.

This module compares two :class:`~slappyengine.scenes.scene.Scene`
...
Two-line usage::
    ...
    from slappyengine.scenes.scene_diff import diff_scenes, pretty_print_diff
