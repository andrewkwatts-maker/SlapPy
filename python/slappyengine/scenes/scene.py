...
entities placed into a :class:`slappyengine.dynamics.World`. It sits one
level above :class:`slappyengine.prefabs.Prefab` — a scene composes many
...
:class:`slappyengine.scene.Scene` (which owns a live entity graph, event
...
* Every entity is stored as a plain dict so YAML round-trip is lossless
  ...
  mirrors :class:`slappyengine.prefabs.Prefab` — anything the prefab
...
* No mutation of the runtime :class:`slappyengine.scene.Scene` — this
  serialiser only talks to the dynamics :class:`~slappyengine.dynamics.World`
  and the :class:`slappyengine.prefabs.PrefabLibrary`.
"""
...
#: Mirrors :data:`slappyengine.prefabs.prefab._BODY_KINDS`.
...
class Scene:
    ...
    entities:
        ...
        :class:`slappyengine.prefabs.PrefabLibrary`.
    layers:
    ...
    def apply_to_world(
        ...
        *,
        ...
        dict[str, list[Body]]
            ...
            :class:`slappyengine.dynamics.body.Body` handles it created.
    ...
    def snapshot_from_world(
        ...
        Each :class:`slappyengine.dynamics.body.Body` in ``world`` is
...
def _spawn_body_from_scene_dict(
    ...
    *,
    ...
    should route through :class:`slappyengine.prefabs.PrefabLibrary`
    ...
    list[Body]
        ...
        unrecognised.
    """
    from slappyengine.dynamics import Body, JointSpec
