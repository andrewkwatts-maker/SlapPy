...
The visual-scripting backbone borrows the shape of ``slappyengine.material``'s
...
YAML round-trip) lives in :mod:`slappyengine.visual_scripting.graph`. The
builtin palette of 20 starter nodes lives in
:mod:`slappyengine.visual_scripting.palette`.
"""
