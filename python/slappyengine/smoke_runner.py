...
::
    ...
    python -m slappyengine.smoke_runner              # sequential, all demos
    python -m slappyengine.smoke_runner --parallel   # thread-pool fan-out
    python -m slappyengine.smoke_runner --report out.yml
...
def _repo_root() -> Path:
    ...
    ``__file__`` lives at ``<repo>/python/slappyengine/smoke_runner.py``, so
...
def _cli(argv: Optional[Sequence[str]] = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="slappyengine.smoke_runner",
