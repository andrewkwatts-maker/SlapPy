...
class EditorAutosaveIntegration:
    ...
    * ``status_bar.set_message(text, kind)`` (optional — attached via
    ...
    project:
        Optional :class:`slappyengine.project_registry.RegisteredProject`
    ...
    def attach_to_status_bar(self, status_bar: Any) -> None:
        ...
        :class:`slappyengine.ui.editor.notebook_status_bar.NotebookStatusBar`.
...
class _AnonymousProject:
    ...
    land under ``~/.slappyengine/autosave/unnamed/`` in this case, which
