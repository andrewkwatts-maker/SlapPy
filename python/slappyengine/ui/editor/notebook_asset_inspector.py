...
Complement to :class:`~slappyengine.ui.editor.notebook_content_browser.NotebookContentBrowser`
...
* **shader** (``*.wgsl|glsl``) → source, byte count, WARN/ERROR summary
  from :func:`slappyengine.ui.theme.shader_lint.lint_wgsl` (AA6).
* **prefab** (``*.prefab.yaml``) → node count / joint count / bounding
  box + a 64x64 preview baked via :class:`~slappyengine.prefabs.preview_baker.PreviewBaker`
...
``yaml`` / :mod:`slappyengine.ui.theme.shader_lint` / :mod:`slappyengine.prefabs`
...
class NotebookAssetInspector:
    ...
    :class:`~slappyengine.ui.editor.notebook_content_browser.NotebookContentBrowser`
