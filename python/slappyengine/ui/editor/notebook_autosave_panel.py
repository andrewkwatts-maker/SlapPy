...
Visual counterpart to the Y6 :class:`~slappyengine.autosave.AutosaveManager`
+ Z6 :class:`~slappyengine.ui.editor.editor_autosave.EditorAutosaveIntegration`
...
from slappyengine._validation import validate_callable
...
class NotebookAutosavePanel:
    ...
    :class:`~slappyengine.autosave.AutosaveManager` ring buffer: it never
    ...
    only reads the manager for :meth:`~slappyengine.autosave.AutosaveManager.list_snapshots`
    and pokes it via :meth:`~slappyengine.autosave.AutosaveManager.force_save`
    ...
    integration:
        Optional
        :class:`~slappyengine.ui.editor.editor_autosave.EditorAutosaveIntegration`.
