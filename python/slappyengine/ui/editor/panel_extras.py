...
.. code-block:: python
    ...
    from slappyengine.ui.editor.panel_extras import (
        ExtendedCornerSpec,
...
def _load_tape_renderer() -> Callable[..., Any] | None:
    ...
    """
    try:
        from slappyengine.ui.theme.washi_tape import render_tape  # type: ignore
        return render_tape
    except Exception:
        return None
...
class ExtendedPanelDecorator:
    ...
    tape_registry:
        ...
        decorator soft-imports :func:`slappyengine.ui.theme.washi_tape.render_tape`
