...
every ``*.wgsl`` file under :mod:`slappyengine.render.shaders` in a
...
* **Zero required deps.** wgpu is soft-imported through
  :mod:`slappyengine.render.shader_hot_reload`; when it's missing the
...
from slappyengine.render.shader_hot_reload import (
    CompileResult,
    ShaderHotReloader,
