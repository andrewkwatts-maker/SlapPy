...
class CodeModePanel:
    ...
    def _init_llm(self) -> None:
        ...
        """
        try:
            from slappyengine.ai.ollama_manager import load_ai_settings, OllamaManager
            ...
            if mgr.is_server_running() and mgr.is_model_installed(model):
                from slappyengine.ai import LLMClient
                self._llm = LLMClient()
    ...
    def _trigger_setup(self) -> None:
        ...
        if needs_pull:
            from slappyengine.ui.editor.ollama_setup_modal import OllamaSetupModal
    ...
    def _run_p2c(self) -> None:
        ...
        try:
            from slappyengine.ai.code_sync import prompt_to_code
    ...
    def _run_c2p(self) -> None:
        ...
        try:
            from slappyengine.ai.code_sync import code_to_prompt
            loop = asyncio.new_event_loop()
    ...
    def load_script(self, script_path: Path) -> None:
        ...
        import dearpygui.dearpygui as dpg
        from slappyengine.ai.code_sync import prompt_path_for, CodeSyncWatcher
