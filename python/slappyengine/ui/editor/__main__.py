"""``python -m slappyengine.ui.editor [<project_dir>]`` entry point.

Boots the notebook editor shell on top of a headless :class:`~slappyengine.engine.Engine`.
Referenced by :func:`slappyengine.scaffold.launch_project` when the
