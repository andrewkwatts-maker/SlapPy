...
The :mod:`slappyengine.ui.runtime` package provides a *lightweight*,
DPG-free UI stack usable from a game tick loop. The editor-side
:mod:`slappyengine.ui.editor` package is a superset (dockable panels,
...
* Theme colours come from :class:`RuntimeTheme`, which soft-imports the
  editor :class:`~slappyengine.ui.theme.theme_spec.ThemeSpec` when
