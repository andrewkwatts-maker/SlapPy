...
Translates the declarative :class:`~slappyengine.ui.theme.theme_spec.ThemeSpec`
into a live Dear PyGui ``theme`` resource. The translation maps every
:class:`~slappyengine.ui.theme.theme_spec.FrameStyle` token onto the
matching ``mvStyleVar_*`` and every relevant
:class:`~slappyengine.ui.theme.theme_spec.SemanticTokens` colour onto the
...
from slappyengine._validation import validate_non_empty_str  # noqa: E402
