...
:mod:`slappyengine.config` (which parses the small ``engine.yml`` shipped in
...
DEFAULT_CONFIG_OPTIONS: list[ConfigOption] = [
    ...
    _opt("runtime.save_dir", "~/.slappyengine/saves", "str",
         "Directory where save-game files are written.", "runtime"),
    _opt("runtime.cache_dir", "~/.slappyengine/cache", "str",
...
def generate_default_yaml(
    *,
    ...
    lines: list[str] = [
        ...
        "# ----------------------------------",
        "# This file was generated by slappyengine.config_defaults.",
