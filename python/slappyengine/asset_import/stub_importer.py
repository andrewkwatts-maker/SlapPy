...
call :func:`slappyengine.asset_import.import_asset` without crashing
...
log = logging.getLogger("slappyengine.asset_import")
...
def _empty_result(path: Path, importer: str, reason: str) -> ImportResult:
    log.warning(
        ...
        "Install with: pip install slappyengine[assets]",
