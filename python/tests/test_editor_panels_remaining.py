...
Covers:
- pharos_engine.ui.editor.anim_graph_panel    (AnimGraphPanel)
- pharos_engine.ui.editor.layer_lighting_panel (LayerLightingPanel + _LIGHTING_MODES)
- pharos_engine.ui.editor.material_editor      (MaterialEditor + _ALPHA_MEANINGS)
- pharos_engine.ui.editor.mesh_inspector       (MeshInspector)
- pharos_engine.ui.editor.node_graph_panel     (NodeGraphPanel + module constants)
- pharos_engine.ui.editor.shell                (EditorShell)
- pharos_engine.net.discovery                  (module-level constants)
...
class TestLightingModeConstant:
    def test_lighting_modes_is_list(self):
        from pharos_engine.ui.editor.layer_lighting_panel import _LIGHTING_MODES
...
class TestLayerLightingPanelInit:
    def test_instantiates(self):
        from pharos_engine.ui.editor.layer_lighting_panel import LayerLightingPanel
...
class TestMeshInspectorInit:
    def test_instantiates(self):
        from pharos_engine.ui.editor.mesh_inspector import MeshInspector
        p = MeshInspector()
        assert p is not None
...
class TestNodeGraphPanelModuleConstants:
    def test_port_schema_is_dict(self):
        from pharos_engine.ui.editor.node_graph_panel import _PORT_SCHEMA
    ...
    def test_float_params_is_frozenset(self):
        from pharos_engine.ui.editor.node_graph_panel import _FLOAT_PARAMS
    ...
    def test_add_menu_is_dict(self):
        from pharos_engine.ui.editor.node_graph_panel import _ADD_MENU
    ...
    def test_default_params_is_dict(self):
        from pharos_engine.ui.editor.node_graph_panel import _DEFAULT_PARAMS
...
class TestNodeGraphPanelInit:
    def test_instantiates(self):
        from pharos_engine.ui.editor.node_graph_panel import NodeGraphPanel
        p = NodeGraphPanel()
        assert p is not None
...
class TestDiscoveryModuleConstants:
    def test_dht_bootstrap_is_list(self):
        from pharos_engine.net.discovery import _DHT_BOOTSTRAP
    ...
    def test_stun_servers_is_list(self):
        from pharos_engine.net.discovery import _STUN_SERVERS
    ...
    def test_discovery_module_importable(self):
        import pharos_engine.net.discovery as d
