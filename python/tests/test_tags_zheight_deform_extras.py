...
class TestZoneDef:
    def test_instantiates(self):
        from slappyengine.deform_zones import ZoneDef
...
class TestCrackConstants:
    def test_crack_none(self):
        from slappyengine.deform_crack import CRACK_NONE
        assert CRACK_NONE == -1

    def test_crack_radial(self):
        from slappyengine.deform_crack import CRACK_RADIAL
        assert CRACK_RADIAL == 0

    def test_crack_grain(self):
        from slappyengine.deform_crack import CRACK_GRAIN
        assert CRACK_GRAIN == 1

    def test_distinct(self):
        from slappyengine.deform_crack import CRACK_NONE, CRACK_RADIAL, CRACK_GRAIN
