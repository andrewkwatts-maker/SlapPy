...
Covers:
- slappyengine.ui.editor.property_inspector  (module helpers + PropertyInspector)
- slappyengine.ui.editor.deform_panel        (module helpers + DeformPanel + ZoneEditorPanel)
- slappyengine.ui.editor.scene_outliner      (SceneOutliner)
...
class TestIsFloatTuple:
    def _fn(self, v):
        from slappyengine.ui.editor.property_inspector import _is_float_tuple
...
class TestIsListOfStr:
    def _fn(self, v):
        from slappyengine.ui.editor.property_inspector import _is_list_of_str
...
class TestIsEngineObject:
    def _fn(self, v):
        from slappyengine.ui.editor.property_inspector import _is_engine_object
    ...
    def test_plain_class_false(self):
        # module is __main__ / tests, not slappyengine.*
        assert self._fn(_PlainObj()) is False
...
class TestPropertyInspectorConstants:
    ...
    def test_drag_float_names_contains_width(self):
        from slappyengine.ui.editor.property_inspector import DRAG_FLOAT_NAMES
...
class TestEnumItems:
    def _fn(self, cls):
        from slappyengine.ui.editor.deform_panel import _enum_items
...
class TestEnumValue:
    def _fn(self, v):
        from slappyengine.ui.editor.deform_panel import _enum_value
...
class TestSafeSetattr:
    def _fn(self, obj, attr, val):
        from slappyengine.ui.editor.deform_panel import _safe_setattr
...
class TestDeformPanelInit:
    def test_instantiates(self):
        from slappyengine.ui.editor.deform_panel import DeformPanel
        p = DeformPanel()
...
class TestZoneEditorPanelInit:
    def test_instantiates(self):
        from slappyengine.ui.editor.deform_panel import ZoneEditorPanel
        p = ZoneEditorPanel()
        assert p is not None
