...
class TestProjectManagerHelpers:
    def test_load_recent_no_crash(self):
        from slappyengine.ui.project_manager import _load_recent
        result = _load_recent()
        assert isinstance(result, list)

    def test_add_recent_creates_entry(self, tmp_path, monkeypatch):
        from slappyengine.ui import project_manager as pm
...
class TestProjectManagerAPI:
    def _make_api(self, tmp_path):
        from slappyengine.ui.project_manager import ProjectManagerAPI
