...
class TestMonotoneChain:
    def test_square(self):
        from pharos_engine.compute.library import _monotone_chain
...
class TestCircumradius:
    def test_right_triangle(self):
        from pharos_engine.compute.library import _circumradius
        a = np.array([0.0, 0.0])
        b = np.array([1.0, 0.0])
        c = np.array([0.0, 1.0])
...
class TestLoadSaveAiSettings:
    def test_load_missing_returns_empty(self):
        ...
        import pharos_engine.ai.ollama_manager as m
    ...
    def test_save_and_reload(self):
        from pharos_engine.ai.ollama_manager import load_ai_settings, save_ai_settings
        import pharos_engine.ai.ollama_manager as m
        td = tempfile.mkdtemp()
...
class TestOllamaManagerConstants:
    ...
    def test_percent_re_matches(self):
        from pharos_engine.ai.ollama_manager import _PERCENT_RE
...
class TestBuildParser:
    def _p(self):
        from pharos_engine.cli import _build_parser
