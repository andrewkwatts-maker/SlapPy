...
class TestPixelMaterialMapConstruction:
    def test_default_shape(self):
        from slappyengine.pixel_material import PixelMaterialMap
    ...
    def test_from_uniform_flags_stored(self):
        from slappyengine.pixel_material import PixelMaterialMap, MaterialFlags
...
class TestMaterialFlags:
    def test_structural_flag_value(self):
        from slappyengine.pixel_material import MaterialFlags
