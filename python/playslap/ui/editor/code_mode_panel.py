...
For .py asset scripts a background :class:`~playslap.ai.code_sync.CodeSyncWatcher`
...
class CodeModePanel:
    ...
    :meth:`~playslap.ui.editor.shell.EditorShell.register_panel`.
    """
    ...
    def _init_llm(self) -> None:
        ...
        Decision tree
        -------------
        1. Load ~/.playslap/ai_settings.json.
        ...
        """
        try:
            from playslap.ai.ollama_manager import load_ai_settings, OllamaManager
            ...
            if mgr.is_server_running() and mgr.is_model_installed(model):
                from playslap.ai import LLMClient
                self._llm = LLMClient()
    ...
    def _trigger_setup(self) -> None:
        ...
        if not settings:
            from playslap.ui.editor.ollama_setup_modal import AiOptInDialog
        ...
        if needs_pull:
            from playslap.ui.editor.ollama_setup_modal import OllamaSetupModal
    ...
    def build(self, parent_tag) -> None:
        ...
        Called by :class:`~playslap.ui.editor.shell.EditorShell` during
        ``setup()``.
        """
        import dearpygui.dearpygui as dpg
    ...
    def _run_p2c(self) -> None:
        ...
        try:
            from playslap.ai.code_sync import prompt_to_code
    ...
    def _run_c2p(self) -> None:
        ...
        try:
            from playslap.ai.code_sync import code_to_prompt
            loop = asyncio.new_event_loop()
            ...
            if self._script_path:
                from playslap.ai.code_sync import prompt_path_for
    ...
    def load_script(self, script_path: Path) -> None:
        ...
        import dearpygui.dearpygui as dpg
        from playslap.ai.code_sync import prompt_path_for, CodeSyncWatcher
