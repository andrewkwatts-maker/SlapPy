"""playslap.iso — Isometric 2D-grid-with-Z rendering subsystem.
...
Quick start::
    ...
    from playslap.iso import IsoScene, IsoTileDef, IsoEntity, IsoViewpoint
...
Public API
----------
The following names are importable directly from ``playslap.iso``:
"""
