...
from playslap.compute.stats import StatsCompute, StatsResult
from playslap.compute.spatial import SpatialCompute, AABB
from playslap.compute.mutator import PixelMutator
from playslap.compute.pipeline import ComputePass, ComputePipeline
...
class PixelAPI:
    ...
    def apply(self, *, filter, mutation, target_channel: str,
              layer: int = 0) -> None:
        from playslap.compute.ast_compiler import compile_apply_shader, ASTCompilerError
