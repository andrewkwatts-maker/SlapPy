...
Backs the ``view.frame_selected`` :class:`~pharos_editor.tool_router.ToolAction`
...
Distinct from the already-wired :func:`pharos_editor.actions.viewport_framing_actions.center_on_selection`
