...
Backs the ``content.copy_asset_path`` :class:`~pharos_editor.tool_router.ToolAction`
row added by the CC1 STUB-triage sprint tick.

The action prefers routing through
:meth:`pharos_editor.ui.editor.notebook_content_browser.NotebookContentBrowser.copy_path`
