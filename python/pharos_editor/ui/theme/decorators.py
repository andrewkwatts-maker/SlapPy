...
the class applies :func:`~pharos_editor.ui.theme.edge_strokes.render_edge_stroke`
...
lives in :mod:`pharos_editor.ui.theme.dpg_bridge`.
"""
...
class PanelDecorator:
    ...
    ----------
    edge_stroke_preset:
        A key from :data:`~pharos_editor.ui.theme.edge_strokes.EDGE_STROKE_PRESETS`.
    ...
    def build_edge_tiles(
        ...
        :func:`~pharos_editor.ui.theme.edge_strokes.render_stroke_border`.
        """
