...
Translates the declarative :class:`~pharos_editor.ui.theme.theme_spec.ThemeSpec`
into a live Dear PyGui ``theme`` resource. The translation maps every
:class:`~pharos_editor.ui.theme.theme_spec.FrameStyle` token onto the
matching ``mvStyleVar_*`` and every relevant
:class:`~pharos_editor.ui.theme.theme_spec.SemanticTokens` colour onto the
