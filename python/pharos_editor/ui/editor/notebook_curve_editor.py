...
:class:`~pharos_editor.ui.editor.notebook_timeline_editor.NotebookTimelineEditor`.
...
* Track / property selector at the top switches which
  :class:`~pharos_editor.ui.editor.notebook_timeline_editor.TimelineTrack`
  is being edited.
...
from pharos_editor.ui.editor.notebook_timeline_editor import (
    INTERP_KINDS,
    TimelineKeyframe,
    TimelineTrack,
)
