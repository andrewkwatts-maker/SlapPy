...
_LAZY_MAP: dict[str, str] = {
    ...
    "NotebookAssetInspector": ".notebook_asset_inspector",
    "NotebookAutosavePanel":  ".notebook_autosave_panel",
    "NotebookCommandPalette": ".notebook_command_palette",
    "NotebookCurveEditor":    ".notebook_curve_editor",
    ...
    "NotebookMenuBar":        ".notebook_menu_bar",
    "NotebookMessageLog":     ".notebook_message_log",
    "NotebookMinimap":        ".notebook_minimap",
    "NotebookPPPreviewPanel": ".notebook_pp_preview",
    ...
    "NotebookTelemetryDashboard": ".notebook_telemetry_dashboard",
    "NotebookTimelineEditor": ".notebook_timeline_editor",
    "NotebookToastManager":   ".notebook_toast_manager",
