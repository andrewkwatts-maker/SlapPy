...
Complement to :class:`~pharos_editor.ui.editor.notebook_content_browser.NotebookContentBrowser`
...
* **shader** (``*.wgsl|glsl``) → source, byte count, WARN/ERROR summary
  from :func:`pharos_editor.ui.theme.shader_lint.lint_wgsl` (AA6).
...
``yaml`` / :mod:`pharos_editor.ui.theme.shader_lint` / :mod:`pharos_engine.prefabs`
...
class NotebookAssetInspector:
    ...
    :class:`~pharos_editor.ui.editor.notebook_content_browser.NotebookContentBrowser`
