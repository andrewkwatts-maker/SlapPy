...
:func:`pharos_editor.ui.theme.get_active_theme` and writes via
:func:`pharos_editor.ui.theme.apply_theme`. Creature toggles route
...
Integration
-----------
Register with :class:`pharos_editor.ui.editor.shell.EditorShell` from
...
def _color_tuple(color: Any, default: tuple[int, int, int, int]) -> tuple[int, int, int, int]:
    ...
    Accepts :class:`pharos_editor.ui.theme.Color`, plain 4-tuples / lists,
...
class ThemeSwitcherPanel:
    ...
    :class:`~pharos_editor.ui.editor.shell.EditorShell.register_panel` and
    ...
    scheduler:
        ...
        :class:`pharos_editor.ui.theme.creatures.CreatureScheduler`
    ...
    def card_preview(self, theme_id: str) -> dict[str, Any]:
        ...
        try:
            from pharos_editor.ui.theme import _REGISTRY
    ...
    def _build_footer(self, dpg: Any) -> None:
        try:
            from pharos_editor.ui.widgets import StickerButton
