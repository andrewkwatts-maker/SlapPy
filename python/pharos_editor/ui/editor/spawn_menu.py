...
- ``spec`` — dataclass type describing the factory's input parameters.
  ...
  :class:`~pharos_editor.ui.editor.property_inspector.PropertyInspector`
...
SPAWN_ACTIONS: list[dict] = [
    ...
    {
        "label":   "Add Rope",
        "factory": "pharos_editor.ui.editor.spawn_menu._spawn_rope",
        "spec":    RopeSpawnSpec,
    },
    {
        "label":   "Add Ragdoll",
        "factory": "pharos_editor.ui.editor.spawn_menu._spawn_ragdoll",
        "spec":    RagdollSpawnSpec,
    },
    {
        "label":   "Add IK Chain",
        "factory": "pharos_editor.ui.editor.spawn_menu._spawn_ik_chain",
        "spec":    IKChainSpawnSpec,
    },
    {
        "label":   "Add Humanoid",
        "factory": "pharos_editor.ui.editor.spawn_menu._spawn_humanoid",
