...
class SceneOutliner:
    ...
    In addition, when a :class:`pharos_engine.dynamics.World` is attached via
    ...
    def set_dynamics_world(self, world: Any) -> None:
        """Attach a :class:`pharos_engine.dynamics.World` for tree display.
    ...
    def build(self, parent_tag: str | int) -> None:
        ...
        from pharos_editor.ui.editor.theme import get_accent_button_theme, get_default_button_theme
