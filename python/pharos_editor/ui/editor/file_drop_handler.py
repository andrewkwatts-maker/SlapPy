...
* Companion of :mod:`pharos_editor.ui.editor.notebook_prefab_menu` —
...
* Style / patterns: dataclass event + enum action + registered
  callback (mirrors :mod:`pharos_editor.ui.editor.notebook_command_palette`).
"""
...
class FileDropHandler:
    ...
    def handle_drop(
        ...
        ctx:
            ...
            :class:`pharos_editor.ui.editor.shell.EditorShell` instance
...
def default_handlers() -> dict[DropAction, HandlerCallback]:
    ...
    * ``user_theme_store`` — :class:`pharos_editor.ui.theme.user_themes.UserThemeStore`.
