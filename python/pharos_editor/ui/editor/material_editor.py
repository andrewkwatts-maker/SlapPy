...
# know the kind).
KIND_MATERIAL_MAP = "material_map"   # pharos_engine.material.MaterialMap
...
def _detect_kind(target: Any) -> str:
    ...
    if mod.startswith("pharos_engine.fluid"):
        return KIND_FLUID
    if mod.startswith("pharos_engine.softbody"):
...
class MaterialEditor:
    ...
    ``"material_map"``
        Legacy :class:`pharos_engine.material.map.MaterialMap` mode.  One
    ...
    def set_material_map(self, mat_map) -> None:
        ...
        """
        from pharos_engine.material.map import MaterialMap  # noqa: F401
    ...
    def set_target(self, target: Any, kind: str | None = None) -> None:
        ...
        target:
            ...
            - A :class:`pharos_engine.material.map.MaterialMap`,
    ...
    def _add_material(self) -> None:
        ...
        if self._kind != KIND_MATERIAL_MAP:
            return
        from pharos_engine.material.map import ColorRange, MaterialDef
