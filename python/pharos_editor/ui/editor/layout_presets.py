...
:class:`pharos_editor.ui.editor.layout_persistence.PanelLayoutState`
...
:mod:`pharos_editor.ui.editor.shell` (rows 1-3 of the ``editor_root``
window).
"""
...
from pharos_editor.ui.editor.layout_persistence import PanelLayoutState
