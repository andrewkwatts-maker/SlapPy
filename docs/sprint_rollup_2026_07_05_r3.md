...
| **X**  | `d339995` (X2) → `194a0c9` (X7) | 7 landed | X2 hello_rope fix, X3 STUB triage r1 + actions subpackage, X4 NotebookContentBrowser project view, X5 chain manifest, X6 UserOverrideLoader watchdog, X7 6 widget primitives | Bootstraps `pharos_editor.actions.*` subpackage — the container every later triage round populates. |
