...
| [`engine_surface_v030.md`](engine_surface_v030.md) | v0.3 engine-surface reference — 88 top-level symbols across 22 declared subpackages (includes HH1 ergonomic API and HH5 asset_import; regenerate via `scripts/gen_engine_surface_doc.py`, NN6 refresh 2026-07-06). |
