...
# pharos_editor.ui.widgets — API Reference
...
The `pharos_editor.ui.widgets` subpackage layers a *notebook flavour* on
...
_dataclass — defined in `pharos_editor.ui.widgets.notebook_theme`_
...
_class — defined in `pharos_editor.ui.widgets.sticker_button`_
...
_class — defined in `pharos_editor.ui.widgets.washi_panel`_
...
_class — defined in `pharos_editor.ui.widgets.notebook_tab`_
...
_class — defined in `pharos_editor.ui.widgets.highlighter_slider`_
...
_class — defined in `pharos_editor.ui.widgets.heart_checkbox`_
...
_class — defined in `pharos_editor.ui.widgets.doodle_separator`_
...
- `pharos_editor.ui.widgets.notebook_theme` — `NotebookTheme`, the
  registry, the fallback palette.
- `pharos_editor.ui.widgets._dpg_base` — `_NotebookWidget` base class
  (theme snapshot + build / destroy lifecycle).
- `pharos_editor.ui.widgets.sticker_button` — `StickerButton`.
- `pharos_editor.ui.widgets.washi_panel` — `WashiPanel`.
- `pharos_editor.ui.widgets.notebook_tab` — `NotebookTab`.
- `pharos_editor.ui.widgets.highlighter_slider` — `HighlighterSlider`.
- `pharos_editor.ui.widgets.heart_checkbox` — `HeartCheckbox`.
- `pharos_editor.ui.widgets.doodle_separator` — `DoodleSeparator`.
- `pharos_editor.ui.widgets.sticker_corner` —
