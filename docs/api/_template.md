...
> and `PharosEngineTests/tests/test_docs_links_resolve_all.py` (replace `LBLK` / `RBLK`
> with literal `[` / `]`).
...
The regression test `PharosEngineTests/tests/test_docs_api_template_conformance.py`
...
────────────────────────────────────────────────────────────────────────
  ...
  - Cross-links. Always `LBLK`name.md`RBLK(name.md)` relative form
    ...
    `PharosEngineTests/tests/test_docs_links_resolve_all.py` resolves them; never an
