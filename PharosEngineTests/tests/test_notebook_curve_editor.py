...
def _make_track(name: str = "camera.zoom"):
    from pharos_editor.ui.editor.notebook_timeline_editor import TimelineTrack
    return TimelineTrack(name)


def _make_editor(track=None, **kw):
    from pharos_editor.ui.editor.notebook_curve_editor import NotebookCurveEditor
...
class TestConstruction:
    ...
    def test_title_constant(self):
        from pharos_editor.ui.editor.notebook_curve_editor import (
            NotebookCurveEditor,
        )
    ...
    def test_curve_kinds_constant(self):
        from pharos_editor.ui.editor.notebook_curve_editor import CURVE_KINDS
...
class TestZoom:
    ...
    def test_zoom_clamped_max(self):
        from pharos_editor.ui.editor.notebook_curve_editor import MAX_ZOOM
        ed = _make_editor()
    ...
    def test_zoom_clamped_min(self):
        from pharos_editor.ui.editor.notebook_curve_editor import MIN_ZOOM
        ed = _make_editor()
        ed.zoom(1e-6)
...
class TestRegistration:
    ...
    def test_lazy_import_yields_class(self):
        from pharos_editor.ui.editor import NotebookCurveEditor
...
class TestCurveView:
    def test_view_defaults(self):
        from pharos_editor.ui.editor.notebook_curve_editor import CurveView
        v = CurveView()
