...
def test_import_does_not_load_3d():
    """Importing Pharos Engine must NOT trigger 3D module imports."""
    ...
    assert "Pharos Engine.gpu.mesh_pipeline" not in sys.modules
    assert "Pharos Engine.gpu.pbr_material" not in sys.modules
