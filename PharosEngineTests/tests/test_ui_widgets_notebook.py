...
class TestThemeRegistry:
    def test_no_theme_active_by_default(self):
        from pharos_editor.ui.widgets import get_active_theme
...
class TestNotebookTab:
    def test_constructs(self):
        from pharos_editor.ui.widgets import NotebookTab
...
class TestStickerCorners:
    def test_add_returns_handle(self):
        from pharos_editor.ui.widgets import add_sticker_corner
    ...
    def test_remove_unknown_handle_raises_on_bad_type(self):
        from pharos_editor.ui.widgets import remove_sticker_corner
