...
The NodeMaterial class lives in Pharos Engine.material.node_material, which is
...
def test_node_def_auto_id():
    try:
        ...
        pytest.skip("Pharos Engine.material.node_material not available")
...
def test_graph_schema_valid():
    try:
        ...
        pytest.skip("Pharos Engine.material.graph_schema not available")
