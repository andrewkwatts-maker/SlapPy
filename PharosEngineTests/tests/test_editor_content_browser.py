...
class TestClassifyFile:
    ...
    def test_hidden_file_returns_none(self):
        from pharos_editor.ui.editor.notebook_content_browser import classify_file
...
class TestIcons:
    ...
    def test_icon_for_path_routes_scene(self):
        from pharos_editor.ui.editor.notebook_content_browser import icon_for_path
    ...
    def test_make_file_icon_returns_svgicon(self):
        from pharos_editor.ui.editor.notebook_content_browser import make_file_icon
...
class TestContextActions:
    ...
    def test_reveal_does_not_crash(self, tmp_path, monkeypatch):
        from pharos_editor.ui.editor import notebook_content_browser as mod
        from pharos_editor.ui.editor.notebook_content_browser import (
            NotebookContentBrowser,
        )
