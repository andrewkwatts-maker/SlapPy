"""Tests for :mod:`pharos_editor.ui.theme.edge_strokes`.
...
try:
    ...
    from pharos_editor.ui.theme.edge_strokes import (
        EDGE_STROKES,
        EdgeStrokeStyle,
        bake_stroke_texture,
        get_stroke,
    ...
    pytest.skip(
        f"pharos_editor.ui.theme.edge_strokes not importable: {exc}",
