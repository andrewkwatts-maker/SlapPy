...
def test_washi_tape_presets_registry_has_four_entries() -> None:
    ...
    from pharos_editor.ui.theme.washi_tape import WASHI_TAPE_PRESETS
...
def test_washi_tape_presets_reexported_at_theme_top_level() -> None:
    """The top-level ``pharos_editor.ui.theme`` namespace exports the dict."""
...
def test_render_pink_polka_returns_expected_shape() -> None:
    ...
    from pharos_editor.ui.theme.washi_tape import render_washi_tape
...
def test_notebook_panel_decor_title_tape_shape() -> None:
    ...
    """
    from pharos_editor.ui.editor.notebook_panel_decor import NotebookPanelDecor
