"""Negative-path tests for :mod:`pharos_engine.gpu` public-boundary
...
def test_create_sampler_rejects_typo_filter_mode():
    ...
    from pharos_engine.gpu._validation import validate_filter_mode
...
def test_create_view_rejects_invalid_dimension():
    from pharos_engine.gpu._validation import validate_view_dimension
...
def test_update_camera_rejects_short_matrix():
    ...
    from pharos_engine.gpu._validation import validate_matrix16
...
def test_image_array_rejects_2d_shape():
    ...
    import numpy as np
    from pharos_engine.gpu._validation import validate_image_array
...
def test_validate_positive_int_rejects_zero_width():
    from pharos_engine.gpu._validation import validate_positive_int
...
def test_validate_output_format_rejects_empty():
    from pharos_engine.gpu._validation import validate_output_format
