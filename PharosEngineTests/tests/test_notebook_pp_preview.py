...
def _make_panel(**kwargs):
    from pharos_editor.ui.editor.notebook_pp_preview import (
...
class TestTestImage:
    def test_build_test_image_deterministic(self):
        from pharos_editor.ui.editor.notebook_pp_preview import build_test_image
        a = build_test_image()
        b = build_test_image()
...
class TestRegistration:
    def test_all_lists_class(self):
        from pharos_editor.ui.editor import __all__ as editor_all
