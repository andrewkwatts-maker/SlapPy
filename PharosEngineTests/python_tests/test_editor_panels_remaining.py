...
Covers:
- pharos_editor.ui.editor.anim_graph_panel    (AnimGraphPanel)
- pharos_editor.ui.editor.layer_lighting_panel (LayerLightingPanel + _LIGHTING_MODES)
- pharos_editor.ui.editor.material_editor      (MaterialEditor + _ALPHA_MEANINGS)
- pharos_editor.ui.editor.mesh_inspector       (MeshInspector)
- pharos_editor.ui.editor.node_graph_panel     (NodeGraphPanel + module constants)
- pharos_editor.ui.editor.shell                (EditorShell)
...
class TestLightingModeConstant:
    def test_lighting_modes_is_list(self):
        from pharos_editor.ui.editor.layer_lighting_panel import _LIGHTING_MODES
...
class TestLayerLightingPanelInit:
    def test_instantiates(self):
        from pharos_editor.ui.editor.layer_lighting_panel import LayerLightingPanel
...
class TestMeshInspectorInit:
    def test_instantiates(self):
        from pharos_editor.ui.editor.mesh_inspector import MeshInspector
        p = MeshInspector()
        assert p is not None
...
class TestNodeGraphPanelModuleConstants:
    def test_port_schema_is_dict(self):
        from pharos_editor.ui.editor.node_graph_panel import _PORT_SCHEMA
    ...
    def test_float_params_is_frozenset(self):
        from pharos_editor.ui.editor.node_graph_panel import _FLOAT_PARAMS
    ...
    def test_add_menu_is_dict(self):
        from pharos_editor.ui.editor.node_graph_panel import _ADD_MENU
    ...
    def test_default_params_is_dict(self):
        from pharos_editor.ui.editor.node_graph_panel import _DEFAULT_PARAMS
...
class TestNodeGraphPanelInit:
    def test_instantiates(self):
        from pharos_editor.ui.editor.node_graph_panel import NodeGraphPanel
        p = NodeGraphPanel()
        assert p is not None
