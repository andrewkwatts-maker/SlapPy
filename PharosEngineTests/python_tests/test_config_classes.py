...
class TestWindowConfig:
    def test_init(self):
        from pharos_engine.config import WindowConfig
        wc = WindowConfig(
...
class TestRenderingConfig:
    def test_defaults(self):
        from pharos_engine.config import RenderingConfig
        rc = RenderingConfig(
...
class TestLoadConfig:
    def test_load_from_scaffolded_dir(self, tmp_path):
        ...
        from pharos_engine.config import _scaffold_first_run, load_config
