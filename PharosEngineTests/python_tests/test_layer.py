...
class TestLayer3DDefaults:
    def test_instantiates(self):
        from pharos_engine.layer import Layer3D
        l = Layer3D()
        assert l is not None
...
class TestLayer3DProperties:
    ...
    def test_gbuffer_target_setter_updates_mode(self):
        from pharos_engine.layer import Layer3D, Layer2D
        l3 = Layer3D()
    ...
    def test_apply_heightmap_non_3d_raises(self):
        from pharos_engine.layer import Layer, Layer2D
        l = Layer.blank(32, 32)
...
class TestLayerDataBuffer:
    def test_instantiates(self):
        from pharos_engine.layer import LayerDataBuffer
    ...
    def test_is_layer2d_subclass(self):
        from pharos_engine.layer import LayerDataBuffer, Layer2D
        l = LayerDataBuffer("buf", 8, 8, ["f"])
        assert isinstance(l, Layer2D)
