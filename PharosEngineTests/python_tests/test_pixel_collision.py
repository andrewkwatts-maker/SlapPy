...
class TestPixelContactResult:
    ...
    def test_no_contact_sentinel(self):
        from pharos_engine.collision_pixel import _NO_CONTACT
...
class TestPixelCollisionPassInit:
    ...
    def test_ready_state(self):
        from pharos_engine.collision_pixel import PixelCollisionPass, _WGPU_OK, _SHADER_PATH
        p = PixelCollisionPass()
...
class TestPixelCollisionPassTestMethod:
    def test_returns_no_contact_when_not_ready(self):
        from pharos_engine.collision_pixel import PixelCollisionPass, _NO_CONTACT
        p = PixelCollisionPass()
        if p._ready:
...
class TestParamsLayout:
    def test_params_format_size(self):
        ...
        import struct
        from pharos_engine.collision_pixel import _PARAMS_FORMAT, _PARAMS_SIZE
    ...
    def test_result_format_size(self):
        ...
        import struct
        from pharos_engine.collision_pixel import _RESULT_FORMAT, _RESULT_SIZE
    ...
    def test_params_pack_unpack_roundtrip(self):
        ...
        import struct
        from pharos_engine.collision_pixel import _PARAMS_FORMAT
