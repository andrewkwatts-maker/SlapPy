"""Tests for :mod:`slappyengine.ui.runtime` — HH7 immediate-mode game UI.
...
from slappyengine.ui.runtime import (
    AmmoCounter,
    Compass,
    DrawCommand,
    HealthBar,
...
def test_dpg_bridge_soft_skip_or_run():
    ...
    from slappyengine.ui.runtime.dpg_bridge import run_immediate_in_dpg
...
def test_dpg_bridge_import_does_not_import_dpg():
    ...
    sys.modules.pop("slappyengine.ui.runtime.dpg_bridge", None)
    mod = importlib.import_module("slappyengine.ui.runtime.dpg_bridge")
