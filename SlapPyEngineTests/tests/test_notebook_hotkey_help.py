...
def _make_panel(**kwargs):
    from slappyengine.ui.editor.notebook_hotkey_help import NotebookHotkeyHelp
...
class TestConstruction:
    ...
    def test_title_constant(self):
        from slappyengine.ui.editor.notebook_hotkey_help import (
            NotebookHotkeyHelp,
        )
...
class TestEditorRegistration:
    def test_lazy_import_via_editor_init(self):
        from slappyengine.ui.editor import NotebookHotkeyHelp
...
class TestPreset:
    ...
    def test_preset_options_are_three(self):
        from slappyengine.ui.editor.notebook_hotkey_help import PRESET_OPTIONS
...
class TestKeycaps:
    def test_render_simple_combo(self):
        from slappyengine.ui.editor.notebook_hotkey_help import render_keycaps
