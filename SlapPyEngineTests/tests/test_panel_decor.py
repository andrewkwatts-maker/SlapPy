"""Tests for :mod:`slappyengine.ui.editor.panel_decor`.
...
from slappyengine.ui.editor.panel_decor import (
    DividerSpec,
    DividerStyle,
    PanelDecor,
    WashiCornerSpec,
...
class TestShippingThemes:
    ...
    @pytest.mark.parametrize("module_name,attr_name,expected_divider,expected_corner", [
        ("slappyengine.ui.theme.themes.kawaii_planner",
         "KAWAII_PLANNER", "heart_chain", "tape_pink"),
        ("slappyengine.ui.theme.themes.bullet_journal",
         "BULLET_JOURNAL", "dashed", "tape_yellow"),
        ("slappyengine.ui.theme.themes.cottagecore_garden",
         "COTTAGECORE_GARDEN", "flower_chain", "tape_mint"),
        ("slappyengine.ui.theme.themes.cozy_diary",
         "COZY_DIARY", "pencil_line", "tape_lavender"),
        ("slappyengine.ui.theme.themes.scrapbook_summer",
         "SCRAPBOOK_SUMMER", "star_chain", "tape_blue"),
        ("slappyengine.ui.theme.themes.teengirl_notebook",
