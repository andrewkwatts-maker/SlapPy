...
class TestTooltipRegistry:
    def test_register_stores_entry(self):
        from slappyengine.ui.editor.tooltip_registry import TooltipRegistry
    ...
    def test_register_defaults_to_500ms(self):
        from slappyengine.ui.editor.tooltip_registry import (
            DEFAULT_DELAY_MS,
            TooltipRegistry,
        )
...
class TestSpawnRecents:
    ...
    def test_recent_cards_returns_spawncard_objects(self, tmp_path):
        from slappyengine.ui.editor.notebook_spawn_menu import SpawnCard
...
class TestUndoStack:
    def test_push_undo_redo_round_trip(self):
        from slappyengine.ui.editor.editor_undo import UndoStack
...
class TestEntityClipboard:
    def test_copy_stores_snapshot(self):
        from slappyengine.ui.editor.entity_clipboard import EntityClipboard
...
class TestSaveOnQuitPrompt:
    def test_clean_scene_quits_directly(self):
        from slappyengine.ui.editor.save_on_quit import SaveOnQuitPrompt
    ...
    def test_resolve_save_calls_save_then_quit(self, stub_dpg):
        from slappyengine.ui.editor.save_on_quit import (
            SaveOnQuitPrompt,
            SavePromptChoice,
        )
