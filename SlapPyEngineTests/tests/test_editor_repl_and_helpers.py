...
* Every helper in :mod:`slappyengine.editor.helpers` is importable,
...
class TestHelperSurface:
    ...
    def test_editor_package_importable(self):
        import slappyengine.editor as ed
...
class TestSpawning:
    def test_spawn_cube_returns_model_handle_with_position(self, fresh_app):
        from slappyengine.app import ModelHandle
        from slappyengine.editor.helpers import spawn_cube
    ...
    def test_spawn_sphere_uses_radius_as_scale(self, fresh_app):
        from slappyengine.editor.helpers import spawn_sphere
    ...
    def test_spawn_plane_maps_size_to_xz(self, fresh_app):
        from slappyengine.editor.helpers import spawn_plane
    ...
    def test_spawn_light_returns_light_handle(self, fresh_app):
        from slappyengine.app import LightHandle
        from slappyengine.editor.helpers import spawn_light
    ...
    def test_set_camera_marks_active(self, fresh_app):
        from slappyengine.editor.helpers import set_camera
...
class TestTransforms:
    def test_move_translates(self, fresh_app):
        from slappyengine.editor.helpers import move, spawn_cube
    ...
    def test_rotate_adds(self, fresh_app):
        from slappyengine.editor.helpers import rotate, spawn_cube
    ...
    def test_scale_multiplies(self, fresh_app):
        from slappyengine.editor.helpers import scale, spawn_cube
    ...
    def test_delete_removes_from_app(self, fresh_app):
        from slappyengine.editor.helpers import delete, spawn_cube
    ...
    def test_clear_scene_empties_everything(self, fresh_app):
        from slappyengine.editor.helpers import (
...
class TestSelection:
    ...
    def test_select_finds_by_id(self, fresh_app):
        from slappyengine.editor.helpers import select, spawn_cube
    ...
    def test_select_none_on_miss(self, fresh_app):
        from slappyengine.editor.helpers import select
...
class TestSceneIO:
    ...
    def test_set_background_updates_config(self, fresh_app):
        from slappyengine.editor.helpers import set_background
    ...
    def test_load_shader_reads_file(self, fresh_app, tmp_path):
        from slappyengine.editor.helpers import ShaderHandle, load_shader
...
class TestHelpCheatSheet:
    def test_help_returns_markdown_with_every_helper(self):
        from slappyengine.editor.helpers import help as helpers_help

        text = helpers_help()
        assert isinstance(text, str)
        assert text.startswith("# SlapPyEngine editor helpers")
        for name in EXPECTED_HELPERS:
            if name == "help":
