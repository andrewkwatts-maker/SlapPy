...
class TestLLMClientImport:
    ...
    def test_default_host_constant(self):
        from slappyengine.ai import llm_client
    ...
    def test_require_httpx_raises_import_error_hint(self, monkeypatch):
        ...
        try:
            from slappyengine.ai.llm_client import _require_httpx
...
class TestOllamaManagerImport:
    ...
    def test_settings_constants(self):
        from slappyengine.ai.ollama_manager import _SETTINGS_DIR, _SETTINGS_FILE
        assert "SlapPyEngine" in str(_SETTINGS_DIR)
    ...
    def test_save_and_load_ai_settings(self, tmp_path, monkeypatch):
        import slappyengine.ai.ollama_manager as om
