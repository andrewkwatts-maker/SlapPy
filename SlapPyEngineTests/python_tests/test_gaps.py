...
class TestHullCompute:
    def test_import(self):
        from slappyengine.compute.hull import HullCompute
        assert HullCompute is not None

    def test_import_from_engine(self):
        from slappyengine import HullCompute
        assert HullCompute is not None
...
class TestRayMarchNode:
    ...
    def test_import_from_engine(self):
        from slappyengine import RayMarchNode
        assert RayMarchNode is not None

    def test_returns_nodedef(self):
        from slappyengine.material.node_material import RayMarchNode, NodeDef
        node = RayMarchNode()
    ...
    def test_serialisable(self):
        from slappyengine.material.node_material import RayMarchNode, NodeMaterial
...
class TestScrollView:
    ...
    def test_import_from_engine(self):
        from slappyengine import ScrollView
        assert ScrollView is not None
    ...
    def test_is_panel_subclass(self):
        from slappyengine.ui.widgets import ScrollView, Panel
