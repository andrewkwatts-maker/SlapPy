...
class TestThemeDark:
    def test_dark_returns_theme(self):
        from slappyengine.ui.widgets import Theme
        t = Theme.dark()
...
class TestWidgetInit:
    def test_defaults(self):
        from slappyengine.ui.widgets import Widget
        w = Widget()
        assert w.x == 0
        assert w.y == 0
        assert w.w == 100
...
class TestWidgetApplyTheme:
    def test_apply_theme_updates_theme(self):
        from slappyengine.ui.widgets import Widget, Theme
        w = Widget()
...
class TestLabel:
    def test_init_text(self):
        from slappyengine.ui.widgets import Label
        lb = Label(text="hello")
...
class TestButton:
    def test_init_label(self):
        from slappyengine.ui.widgets import Button
        b = Button(label="OK")
        assert b.label == "OK"
...
class TestProgressBar:
    def test_init_value(self):
        from slappyengine.ui.widgets import ProgressBar
...
class TestStatBar:
    def test_init_label(self):
        from slappyengine.ui.widgets import StatBar
    ...
    def test_is_progress_bar(self):
        from slappyengine.ui.widgets import StatBar, ProgressBar
...
class TestSlider:
    def test_init_range(self):
        from slappyengine.ui.widgets import Slider
...
class TestDial:
    def test_init_value(self):
        from slappyengine.ui.widgets import Dial
        d = Dial(value=0.3)
...
class TestPanel:
    def test_add_child(self):
        from slappyengine.ui.widgets import Panel, Label
    ...
    def test_apply_theme_cascades(self):
        from slappyengine.ui.widgets import Panel, Label, Theme
        p = Panel()
        lb = Label()
        p.add(lb)
        new_theme = Theme.light()
    ...
    def test_handle_event_dispatches_to_children(self):
        from slappyengine.ui.widgets import Panel, Button
    ...
    def test_invisible_panel_no_draw(self):
        from slappyengine.ui.widgets import Panel
        p = Panel(x=0, y=0, w=200, h=100)
        p.visible = False
        draw, img = _make_draw()
        p.draw(draw)
...
class TestCheckbox:
    def test_init_unchecked(self):
        from slappyengine.ui.widgets import Checkbox
        cb = Checkbox()
...
class TestDropdown:
    def test_init_options(self):
        from slappyengine.ui.widgets import Dropdown
...
class TestImageWidget:
    def test_init_no_image(self):
        from slappyengine.ui.widgets import ImageWidget
...
class TestLayoutBoxInit:
    def test_defaults(self):
        from slappyengine.ui.widgets import LayoutBox
        lb = LayoutBox()
    ...
    def test_add_child(self):
        from slappyengine.ui.widgets import LayoutBox, Label
        lb = LayoutBox()
        lbl = Label(text="test")
        result = lb.add(lbl)
        assert result is lb
...
class TestLayoutBoxApplyTheme:
    def test_theme_cascades_to_children(self):
        from slappyengine.ui.widgets import LayoutBox, Label, Theme
        lb = LayoutBox()
        lbl = Label()
        lb.add(lbl)
        new_theme = Theme.light()
...
class TestLayoutBoxHandleEvent:
    def test_dispatches_to_child(self):
        from slappyengine.ui.widgets import LayoutBox, Button
