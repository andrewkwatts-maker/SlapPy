...
class TestPhysicsComponent:
    def test_default_velocity_zero(self):
        from pharos_engine.components import PhysicsComponent
        pc = PhysicsComponent()
...
class TestCollisionComponent:
    def test_defaults(self):
        from pharos_engine.components import CollisionComponent
    ...
    def test_satisfies_component_protocol(self):
        from pharos_engine.components import CollisionComponent, Component
        cc = CollisionComponent()
