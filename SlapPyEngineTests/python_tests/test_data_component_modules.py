...
Covers:
- pharos_engine.data_component    (DataComponent — full attribute/watch/bind/tick)
- pharos_engine.modules.health    (HealthModule)
- pharos_engine.modules.physics   (PhysicsModule)
- pharos_engine.modules.fluid_params (FluidParamsModule)
- pharos_engine.modules.pixel_physics (PixelPhysicsModule if present)
"""
