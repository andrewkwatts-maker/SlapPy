...
class TestWaveManager:
    def test_import_does_not_raise(self):
        import slappyengine.wave_manager  # noqa: F401
...
class TestAudioToolsImport:
    def test_import_no_exception(self):
        import slappyengine.tools.audio_tools  # noqa: F401

    def test_functions_exist(self):
        from slappyengine.tools.audio_tools import trim_silence, normalize, loop_seamless
