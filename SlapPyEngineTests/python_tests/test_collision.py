...
class TestCollisionShapes:
    ...
    def test_circle_shape_stores_fields(self):
        from pharos_engine.collision import CircleShape
...
class TestCheckAABB:
    def test_no_overlap_returns_false(self):
        from pharos_engine.collision import AABBShape, check_aabb
        a = _FakeEntity(0, 0)
        b = _FakeEntity(100, 0)
...
class TestCheckCircle:
    def test_distant_circles_no_collision(self):
        from pharos_engine.collision import CircleShape, check_circle
        a = _FakeEntity(0, 0)
        b = _FakeEntity(50, 0)
...
class TestCheckAABBCircle:
    def test_circle_far_from_box_no_collision(self):
        from pharos_engine.collision import AABBShape, CircleShape, check_aabb_circle
...
class TestCollisionWorld:
    def test_register_entity(self):
        from pharos_engine.collision import CollisionWorld, AABBShape
    ...
    def test_unregister_nonexistent_no_error(self):
        from pharos_engine.collision import CollisionWorld
        world = CollisionWorld()
        e = _FakeEntity(0, 0)
    ...
    def test_mixed_shape_types_detected(self):
        from pharos_engine.collision import CollisionWorld, AABBShape, CircleShape
        world = CollisionWorld()
