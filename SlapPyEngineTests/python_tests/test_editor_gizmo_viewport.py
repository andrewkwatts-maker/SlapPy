...
Covers:
- pharos_engine.ui.editor.gizmo_overlay  (GizmoOverlay class constants + pure-Python API)
- pharos_engine.ui.editor.viewport_panel (_look_at, _make_blank_pixels, ViewportPanel)
...
class TestLookAt:
    def test_returns_16_elements(self):
        from pharos_engine.ui.editor.viewport_panel import _look_at
...
class TestMakeBlankPixels:
    def test_length_1x1(self):
        from pharos_engine.ui.editor.viewport_panel import _make_blank_pixels
